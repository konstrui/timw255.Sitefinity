...
namespace timw255.Sitefinity.SuperForms.FormFields.Designers.Views
{
    internal class ProgressiveProfilingView : ContentViewDesignerView
    {
        ...
        protected override string LayoutTemplateName
        {
            get
            {
                return "timw255.Sitefinity.SuperForms.FormFields.Designers.Views.ProgressiveProfilingView.ascx";
            }
        }
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences()
        {
            List<ScriptReference> scriptReferences = new List<ScriptReference>()
            {
                ...
                new ScriptReference("timw255.Sitefinity.SuperForms.FormFields.Designers.Views.ProgressiveProfilingView.js", "timw255.Sitefinity")
            };
