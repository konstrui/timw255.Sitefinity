...
namespace timw255.Sitefinity.SuperForms.FormFields
{
    ...
    public sealed class LogicalFormMultipleChoice : FormMultipleChoice, IConditionalFormControl, IProgressiveFormControl
    {
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences()
        {
            List<ScriptReference> scriptReferences = new List<ScriptReference>(base.GetScriptReferences())
            {
                ...
                new ScriptReference("timw255.Sitefinity.SuperForms.FormFields.LogicalFormMultipleChoice.min.js", "timw255.Sitefinity"),
